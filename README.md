...
图标：https://hexo.fluid-dev.com/img/icon/favicon.png
```

#### 4.2 友链条件

1. 你的网站内容**必须**与**计算机类**相关（不接受其他类申请）
2. 你的网站运营时间不小于**3个月**（以确定不会随随便便删库跑路）
3. 仅接受**已备案**的顶级域名（如果你的博客使用二级域名，需要验证主域名所有权）
4. 你的网站**必须**支持 **HTTPS** 访问（允许不强制跳转）
5. 确保你的网站内容不违反中国大陆法律
6. 拥有尽可能多的原创内容，越多优先级越高
7. 如果因特殊原因而更换网站地址，请再次留言
8. 你的网站**超过30天**无法访问将被移除
...
如果，你的网站拥有 **ICP备案** 或 **ICP备案和公安网监备案**，那么我建议在我的主站上进行友联交换（毕竟咱们都是有 “证” 的人了）。展示的范围也很多，不仅在友情链接页面展示，而且也在站内搜索中以结果的形式展现，网站流量多多，帮助大家引流。

+ 我的主站：[图筑风暻](https://www.nousbuild.org)
+ 主站友联申请：[https://github.com/pudding0503/friends](https://github.com/pudding0503/friends)
